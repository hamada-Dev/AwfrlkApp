            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group bmd-form-group">
                        ...
                        <input type="date" name="license_renew_date" value="{{ isset($row) ? date('Y-m-d', strtotime($row->license_renew_date)) : old('license_renew_date') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="date" name="license_expire_date" value="{{ isset($row) ? date('Y-m-d', strtotime($row->license_expire_date)) : old('license_expire_date') }}"
