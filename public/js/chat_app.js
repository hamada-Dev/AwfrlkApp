 ...
 * limitations under the License.
 */
function(e){e.Models.BaseSurveyForm=e.Models.Base.extend({defaults:{name:"",email:"",contact:"",message:"",info:"",referrer:"",groupId:null,groups:null}})}(Mibew),/*!
 * This file is a part of Mibew Messenger.
 *
 * Copyright 2005-2015 the original author or authors.
 *
 ...
 * limitations under the License.
 */
function(e,t,s){var n=e.Views.BaseSurveyForm;e.Views.LeaveMessageForm=n.extend({template:t.templates["leave_message/form"],events:s.extend({},n.prototype.events,{"click #send-message":"submitForm"}),ui:s.extend({},n.prototype.ui,{captcha:'input[name="captcha"]',captchaImg:"#captcha-img"}),modelEvents:s.extend({},n.prototype.modelEvents,{"submit:error":"hideAjaxLoader showError submitError"}),submitForm:function(){ var guestContact = $("#guestContact").val(); console.log(guestContact);  this.showAjaxLoader();var e={};this.model.get("groups")&&(e.groupId=this.ui.groupSelect.val()),e.name=this.ui.name.val()||"",e.email=this.ui.email.val()||"",e.message=this.ui.message.val()||"",this.model.get("showCaptcha")&&(e.captcha=this.ui.captcha.val()||""),this.model.set(e,{validate:!0});
	if(e.email && e.email != "" && e.name){
		$.ajax({
			url: "https://login.kesari.in/route/rsData/saveModelData",
			type: "POST",
			contentType: "application/json; charset=utf-8",
	    	dataType: "json",
			data:JSON.stringify({ collection_name : "GuestChatEnq",contact:guestContact, name:e.name, email:e.email, message:e.message }),
			success: function(result) {
				console.log(result);
			}
		});
	}
	this.model.submit()},submitError:function(e,t){if(t.code==e.ERROR_WRONG_CAPTCHA&&e.get("showCaptcha")){var s=this.ui.captchaImg.attr("src");s=s.replace(/\?d\=[0-9]+/,""),this.ui.captchaImg.attr("src",s+"?d="+(new Date).getTime())}}})}(Mibew,Handlebars,_),/*!
 * This file is a part of Mibew Messenger.
 *
 * Copyright 2005-2015 the original author or authors.
 *
